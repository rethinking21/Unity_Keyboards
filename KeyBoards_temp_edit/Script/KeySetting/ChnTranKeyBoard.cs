...
namespace Keyboard
{
    public class ChnTraditionalKeySetting : KeySetting
    {
        public ChnTraditionalKeySetting()
        {
            keyString =
    ...
    public class ChnTraditionalKeyMerge : KeyMerge
    {
        string waitString = "";
        string jsonTraditionalPath = "Keyboards/Data/Chn/pinyin_sorted_traditional";

        ChnPinyinDatas pinyinData = null;
        int pinyinIndex = 0;

        public ChnTraditionalKeyMerge()
        {
            key = new ChnTraditionalKeySetting();
            PinyinDataLoad();
        }

        public ChnTraditionalKeyMerge(ChnTraditionalKeySetting engKey)
        {
            key = engKey;
            PinyinDataLoad();
        }
        ...
        void PinyinDataLoad()
        {
            pinyinData = new ChnPinyinDatas(jsonTraditionalPath); //for Traditional characters
